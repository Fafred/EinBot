...
namespace EinBotDB.Migrations
{
    ...
    [Migration("20220914220924_Add-EmbedParts-And-EmbedPartTypes-Tables")]
    partial class AddEmbedPartsAndEmbedPartTypesTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EinBotDB.Models.EinEmbedPartsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("Data01")
                        .HasColumnType("TEXT");

                    b.Property<string>("Data02")
                        .HasColumnType("TEXT");

                    b.Property<string>("Data03")
                        .HasColumnType("TEXT");

                    b.Property<int>("EmbedPartTypesId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("EmbedPartTypesId");

                    b.HasIndex("TableDefinitionsId");

                    b.ToTable("EinEmbedParts");
                });

            modelBuilder.Entity("EinBotDB.Models.EmbedPartTypesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EinBotDB.Models.EinEmbedPartsModel", b =>
                {
                    b.HasOne("EinBotDB.Models.EmbedPartTypesModel", "EmbedPartTypes")
                        .WithMany("EmbedParts")
                        .HasForeignKey("EmbedPartTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EinBotDB.Models.TableDefinitionsModel", "TableDefinitions")
                        .WithMany("EinEmbedParts")
                        .HasForeignKey("TableDefinitionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EmbedPartTypes");
